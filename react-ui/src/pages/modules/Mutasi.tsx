...
export default function MutasiPage({ me }: { me: Me }) {
  ...
  const [detailRow, setDetailRow] = useState<MutasiEntry | null>(null)
    ...
    <section className="section">
                          ...
                          <div className="th-menu" ref={headerMenuRef} onKeyDown={onHeaderMenuKeyDown} style={headerMenuPos ? { position: 'fixed', top: headerMenuPos.top, left: headerMenuPos.left, right: 'auto' } : undefined}>
                            ...
                            <div className="th-menu-section">
                              ...
                              <div className="th-two">
                                <input className="input input-sm" data-autofocus="true" type="date" value={jamDateFrom} onChange={(e) => setJamDateFrom(e.target.value)} />
                        ...
                        createPortal(
                          <div className="th-menu" ref={headerMenuRef} onKeyDown={onHeaderMenuKeyDown} style={headerMenuPos ? { position: 'fixed', top: headerMenuPos.top, left: headerMenuPos.left, right: 'auto' } : undefined}>
                            ...
                            <div className="th-menu-section">
                              ...
                              <input className="input input-sm" data-autofocus="true" value={filterDesc} onChange={(e) => setFilterDesc(e.target.value)} placeholder="Cari..." />
                            </div>
                            <div className="th-menu-actions">
                              <button className="button button-sm button-primary" type="button" onClick={closeHeaderMenu}>
                                Terapkan
                  ...
                  : (
                      <>
                        {useVirtualRows && virtualRange && virtualRange.topPad > 0 && (
                          <tr aria-hidden={true}>
                            <td colSpan={canAdmin ? 7 : 6} style={{ padding: 0, height: virtualRange.topPad }} />
                          </tr>
                        )}
                        ...
                        {useVirtualRows && virtualRange && virtualRange.bottomPad > 0 && (
                          <tr aria-hidden={true}>
                            <td colSpan={canAdmin ? 7 : 6} style={{ padding: 0, height: virtualRange.bottomPad }} />
                          </tr>
                        )}
                      </>
                    )}
      ...
      {detailRow && (
        <Modal open={true} ariaLabel="Detail mutasi" onClose={() => setDetailRow(null)}>
          <div className="modal-header">
            <div className="modal-title">Detail Mutasi</div>
